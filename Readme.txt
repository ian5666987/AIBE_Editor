AIBE Editor a solution created to help to write AIBE scripts with minimal effort and is created solely by me.
...
*) See my AIBE project repository (https://github.com/ian5666987/AIBE.git) for more information.
